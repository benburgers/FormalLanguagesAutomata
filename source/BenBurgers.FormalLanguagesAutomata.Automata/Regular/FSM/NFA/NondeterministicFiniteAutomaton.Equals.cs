...
public partial class NondeterministicFiniteAutomaton<TInputSymbol, TInputSymbolValue, TState>
    : IEquatable<NondeterministicFiniteAutomaton<TInputSymbol, TInputSymbolValue, TState>>
{
    /// <inheritdoc />
    public bool Equals(NondeterministicFiniteAutomaton<TInputSymbol, TInputSymbolValue, TState>? other) =>
        other is not null
    ...
    public override bool Equals(object? obj) =>
        ...
        || (obj is NondeterministicFiniteAutomaton<TInputSymbol, TInputSymbolValue, TState> other
            && this.Equals(other)));
    ...
    public static bool operator ==(
        NondeterministicFiniteAutomaton<TInputSymbol, TInputSymbolValue, TState>? left,
        NondeterministicFiniteAutomaton<TInputSymbol, TInputSymbolValue, TState>? right) =>
