...
{
    /// <summary>
    /// Casts a tuple to a key.
    /// </summary>
    /// <param name="tuple">The tuple to cast.</param>
    public static implicit operator DeterministicPushdownTransitionKey<TInputSymbol, TInputSymbolValue, TState, TStackSymbol>((TState, TInputSymbol, TStackSymbol?) tuple) =>
