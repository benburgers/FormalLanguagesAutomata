...
/// <summary>
/// A deterministic pushdown transition's key.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of <see cref="DeterministicPushdownTransitionKey{TInputSymbol, TInputSymbolValue, TState, TStackSymbol}" />.
    /// </summary>
    /// <param name="state">The state.</param>
    /// <param name="inputSymbol">The input symbol.</param>
    /// <param name="stackSymbol">The stack symbol.</param>
    public DeterministicPushdownTransitionKey(
        TState state,
